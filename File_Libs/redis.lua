...
https.request('https://api.telegram.org/bot'..token..'/sendMessage?chat_id='..Sudo..'&text='..URL.escape("- عمري انهار الريدز افتح السيرفر ودز هذا الامر .\n`service redis start` ")..'&parse_mode=Markdown')
end
os.exit()
