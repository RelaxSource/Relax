...
download_to_file('https://raw.githubusercontent.com/RelaxSource/Relax/master/Relax.lua', 'Relax.lua') 
download_to_file('https://raw.githubusercontent.com/RelaxSource/Relax/master/start.lua', 'start.lua') 
dofile('Relax.lua')  
return false
end
